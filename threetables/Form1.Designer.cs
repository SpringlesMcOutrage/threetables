namespace threetables
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Location = new Point(379, 199);
            label2.Name = "label2";
            ...
            label3.Location = new Point(585, 199);
            label3.Name = "label3";
            ...
            label4.Location = new Point(778, -1);
            label4.Name = "label4";
            ...
            label5.Location = new Point(363, 92);
            label5.Name = "label5";
            label5.Size = new Size(106, 25);
            label5.TabIndex = 4;
            label5.Text = "Портфоліо";
